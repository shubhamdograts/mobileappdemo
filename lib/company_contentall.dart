...
class CompanyContentPageAll extends StatelessWidget {
  const CompanyContentPageAll({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Company Content'),
      ),
      body: CompanyViewAll(),
      );
  }
...
class CompanyViewAll extends StatelessWidget {
